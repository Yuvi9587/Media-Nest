...
class MediaExplorerApp(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Media Nest")
...
# --- KEYBOARD NAVIGATION ---
    ...
    def on_search_bar_typed(self, text):
        # 1. Update the filter text in our custom proxy
        self.proxy_model.set_search_text(text)
        
        # 2. If there is text, automatically expand the matching branches
        if text.strip():
            self.ui.tree_view.expandAll()
        
        # 3. Filter the gallery grid
