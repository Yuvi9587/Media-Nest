...
class VideoContainer(QWidget):
    def __init__(self, main_window):
        ...
        # Spacer block to balance the title on the left and keep the center controls perfect
        self.right_spacer = QWidget()
        self.right_spacer.setFixedWidth(250)
...
class MainWindowUI:
    ...
    def setup_sidebar(self):
        ...
        if not logo_pixmap.isNull():
            scaled_logo = logo_pixmap.scaled(200, 60, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation)
            ...
            self.lbl_sidebar_logo.setStyleSheet("""
                QLabel {
                    background-color: #252526; /* A nice, subtle dark grey */
                    border-radius: 8px;        /* Perfectly matches the button */
                    padding: 5px 10px;         /* Adds breathing room inside the box */
                }
            """)         
